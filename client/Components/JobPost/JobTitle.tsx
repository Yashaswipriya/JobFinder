...
function JobTitle() {
     const { 
        ...
        setActiveEmploymentTypes } = useGlobalContext();
    ...
    useEffect(() => {
        const selectedTypes = Object.keys(employmentTypes).filter(
          (type) =>{return employmentTypes[type as keyof EmploymentTypeProps];
    });
    ...
    <div className='p-6 flex flex-col gap-4 bg-background border border-border rounded-lg'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            <div className='flex-1'>
                ...
                <Label
                htmlFor="jobTitle"
                className='text-sm text-muted-foreground mt-2 text-gray-500'
                >
            ...
            <Input
              ...
              className='flex-1 w-full mt-2 text-gray-500'
            ...
            {Object.entries(employmentTypes).map(([type,checked]) => (
              <div
                  ...
                  <Checkbox
                    id={type}
                    checked={checked}
                    onCheckedChange={() => handleEmploymentTypeChange(type as keyof EmploymentTypeProps)}
                  />
