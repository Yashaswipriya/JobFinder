      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
        ...
        <div className='flex-1 flex flex-col gap-2'>
          <div className='flex flex-wrap gap-2 text-gray-500'>
            ...
            />
            <Button type="button" onClick={handleAddSkill} className='bg-black text-white hover:bg-gray-800 focus:outline-none'>
              Add Skill
            </Button>
          </div>
          <div className='flex flex-wrap gap-2 mt-2 '>
            {skills.map((skill: string, index: number) => (
              <div key={index} 
               className="bg-black text-white px-2 py-1 text-sm rounded-full flex items-center space-x-1"
              >
                <span>{skill}</span>
                <button
                  type="button"
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="flex-1 flex flex-col gap-2">
          <div className="flex gap-2 text-gray-500">
            ...
            />
            <Button type="button" onClick={handleAddTag} className='bg-black text-white  hover:bg-gray-800 focus:outline-none'>
              Add Tag
            </Button>
          </div>
          <div className="flex flex-wrap gap-2 mt-2">
            {tags.map((tag: string, index: number) => (
              <div
                key={index}
                className="bg-black text-white px-2 py-1 rounded-full flex items-center space-x-1"
              >
                <span>{tag}</span>
                <button
